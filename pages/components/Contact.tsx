import { Box, Button, Flex, FormControl, FormLabel, Heading, IconButton, Input, InputGroup, InputLeftElement, Link, Stack, HStack, Textarea, Tooltip, useClipboard, useColorModeValue, VStack } from "@chakra-ui/react"
...
export default function ContactFormWithSocialButtons() {
  ...
  return (
    <section id="contact">
      <Box bgColor={"black"} bgRepeat="no-repeat" backgroundPosition="center" backgroundImage={"ContactCover.svg"}>
        <Flex align="center" justify="center" id="contact" w={"100%"}>
          <Box borderRadius="lg" m={{ base: 5, md: 16, lg: 20 }} p={{ base: 5, lg: 16 }}>
            <Box>
              <VStack spacing={{ base: 4, md: 8, lg: 30 }}>
                <Heading
                  color={"white"}
                  fontSize={{
                    base: "4xl",
                ...
                <HStack align="center" justify="space-around" direction={{ base: "row", md: "column" }}>
                ...
                <Stack spacing={{ base: 4, md: 8, lg: 20 }} direction={{ base: "row", md: "row" }}>
                  <Box bg={useColorModeValue("white", "gray.700")} borderRadius="lg" w={{ base: "280px", md: "750px", lg: "850px" }} p={10} color={useColorModeValue("gray.700", "whiteAlpha.900")} shadow="base">
                    <VStack spacing={5}>
