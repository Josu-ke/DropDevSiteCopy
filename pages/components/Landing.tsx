...
import ParticleBackground from "../../componentsNonReact/ParticleBackground"
      ...
      <section id="home">
        <Box h={"100%"} color={"white"} overflowX="hidden">
          <Flex justifyContent={"center"} flexDir="column">
            <Flex pos={"relative"} bg={"black"} mt={"30px"} alignItems={"center"} justifyContent={"center"} flexWrap="wrap" w={"100%"} h="100%">
          ...
          <Flex mb={"30px"} mt="5%" alignItems={"center"} color={"black"} flexDir="column" w="100%">
